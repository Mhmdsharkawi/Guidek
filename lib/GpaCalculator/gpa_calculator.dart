...
class GuidekScreen extends StatefulWidget {
  @override
  _GuidekScreenState createState() => _GuidekScreenState();
}

class _GuidekScreenState extends State<GuidekScreen> {
